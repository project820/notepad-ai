...
const CURATED: ReadonlyArray<Omit<ModelRef, 'humanizeEngineId'>> = [
  ...
  // Claude (API key).
  { provider: 'claude', id: 'claude-sonnet-4-5', label: 'Claude Sonnet 4.5', requiresAuth: true },
  { provider: 'claude', id: 'claude-opus-4-1', label: 'Claude Opus 4.1', requiresAuth: true },
